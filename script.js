...
const ALUMNI_DATA = [
  {
    id: 1,
    name: "Aravind Kumar",
    photo: "https://ui-avatars.com/api/?name=Aravind+Kumar&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2018 - 2021",
    company: "TCS",
  ...
  },
  {
    id: 2,
    name: "Divya Shree",
    photo: "https://ui-avatars.com/api/?name=Divya+Shree&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2018 - 2021",
  ...
  },
  {
    id: 3,
    name: "Mohammed Irfan",
    photo: "https://ui-avatars.com/api/?name=Mohammed+Irfan&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2018 - 2021",
    company: "Freshworks",
  ...
  //   id: 4,
  //   name: "Priyanka R",
  //   photo: "https://ui-avatars.com/api/?name=Priyanka+R&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
  //   batch: "2017 - 2020",
  //   company: "Government of Tamil Nadu",
  //   position: "Assistant Section Officer",
  //   careerPath: "Government Jobs",
  //   skills: ["Public Administration", "TNPSC", "MS Office"],
  ...
  //   id: 5,
  //   name: "Karthik Raja",
  //   photo: "https://ui-avatars.com/api/?name=Karthik+Raja&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
  //   batch: "2016 - 2019",
  //   company: "Karthik Traders",
  //   position: "Founder",
  //   careerPath: "Entrepreneurship",
  //   skills: ["Business Strategy", "Sales", "Team Building"],
  //   experience: "5 years",
  ...
  //   id: 6,
  //   name: "Sneha Lakshmi",
  //   photo: "https://ui-avatars.com/api/?name=Sneha+Lakshmi&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
  //   batch: "2021 - 2024",
  //   company: "Anna University",
  //   position: "MCA Student",
  //   careerPath: "Higher Studies",
  //   skills: ["Research", "Java", "DBMS"],
  //   experience: "Fresher",
  ...
  //   id: 7,
  //   name: "Vignesh S",
  //   photo: "https://ui-avatars.com/api/?name=Vignesh+S&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
  //   batch: "2015 - 2018",
  //   company: "Infosys",
  //   position: "Technical Lead",
  //   careerPath: "Software Development",
  //   skills: ["Python", "Django", "AWS", "Team Leadership"],
  //   experience: "7 years",
  ...
  //   id: 8,
  //   name: "Ramya Krishnan",
  //   photo: "https://ui-avatars.com/api/?name=Ramya+Krishnan&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
  //   batch: "2019 - 2022",
  //   company: "Cognizant",
  ...
  //   id: 9,
  //   name: "Barath Kumar",
  //   photo: "https://ui-avatars.com/api/?name=Barath+Kumar&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
  //   batch: "2014 - 2017",
  //   company: "Indian Bank",
  //   position: "Probationary Officer",
  //   careerPath: "Government Jobs",
  //   skills: ["Banking Awareness", "IBPS", "Quantitative Aptitude"],
  //   experience: "6 years",
  //   bio: "Cracked IBPS PO on the second attempt while working a private job. Regularly conducts free banking-exam doubt sessions for the department."
  // },
  // {
  //   id: 10,
  //   name: "Nithya Sree",
  //   photo: "https://ui-avatars.com/api/?name=Nithya+Sree&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
  //   batch: "2020 - 2023",
  //   company: "Wipro",
  ...
  //   bio: "Started in manual testing and is now automating regression suites with Selenium. Willing to guide students unsure between dev and QA tracks."
  // },
  // {
  //   id: 11,
  //   name: "Suriya Prakash",
  //   photo: "https://ui-avatars.com/api/?name=Suriya+Prakash&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
  //   batch: "2013 - 2016",
  //   company: "Suriya Digital Studio",
  //   position: "Founder & Creative Director",
  //   careerPath: "Entrepreneurship",
  //   skills: ["Digital Marketing", "Branding", "Client Management"],
  //   experience: "8 years",
  //   bio: "Built a digital marketing agency from freelancing gigs during final year. Open to talking about freelancing while still in college."
  // },
  // {
  //   id: 12,
  //   name: "Keerthana M",
  //   photo: "https://ui-avatars.com/api/?name=Keerthana+M&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
  //   batch: "2022 - 2025",
  //   company: "VIT Vellore",
  ...
  //   experience: "Fresher",
  //   bio: "Chose an M.Tech in AI over immediate placement to build a stronger research base. Can guide on GATE preparation and university shortlisting."
  // }
];
  ...
  return `
    <article class="alumni-card">
      ...
      <div class="card-actions">
        ...
        <button class="card-btn connect-btn" data-id="${alumnus.id}">Connect with Me</button>
      </div>
    </article>
  `;
}
...
function buildWhatsAppMessage(formData, alumnus) {
  const greeting = alumnus ? `Hello ${alumnus.name},` : "Hello Sir/Madam,";
  return (
    `${greeting}\n` +
    "BCA Student New Request\n" +
    `Name: ${formData.name}\n` +
    `Year: ${formData.year}\n` +
